...
<template>
  <div class="flex flex-col">
    <div class="card">
      ...
      <!-- Pass filteredProducts to DataView -->
          ...
          <div class="flex justify-between items-center">
            <div class="filters mb-6">
              ...
              <div>
                ...
                <select id="sousCategorie" v-model="selectedSousCategorie" class="p-2 border rounded" multiple>
                  <option v-for="sousCat in sousCategories" :key="sousCat.id" :value="sousCat.name">
                    {{ sousCat.name }}
                  </option>
                </select>
              </div>

              <!-- Dynamic Field Filters with Provided Values -->
              ...
              <button @click="clearFilters" class="mt-4 p-2 bg-blue-500 text-white rounded">
                Clear Filters
              </button>
            </div>
